...
[Shared channels](/shard-channels) are not returned by this method. Use the [Conversations API](/docs/conversations-api) methods instead, like [`conversations.info`](/methods/conversations.info).
