...
This method shares a remote file into a Slack conversation. If you add a remote file without sharing the file, it remains an orphan inside Slack—you can view information on it via [`files.remote.info`](/methods/files.remote.info) method, but it won't actually be visible anywhere.
...
| `channels` | &nbsp; | Required | Comma-separated list of channel IDs where the file will be shared. |
