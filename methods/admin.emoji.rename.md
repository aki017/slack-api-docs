...
| Method URL: | `https://slack.com/api/admin.emoji.rename` |
...
This [Admin API method](/enterprise/managing) renames a custom emoji across an Enterprise Grid organization.
