...
`bot_id` is returned from [bot\_message message events](/events/message/bot_message) in the response of methods like [channels.history](/methods/channels.history). This method can be used to look up the username and icons for those bot users.
