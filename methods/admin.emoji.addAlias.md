...
| Method URL: | `https://slack.com/api/admin.emoji.addAlias` |
...
This [Admin API method](/enterprise/managing) adds an alias for an emoji across an Enterprise Grid organization.
