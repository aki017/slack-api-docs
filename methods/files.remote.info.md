...
This method shows information on a remote file.
...
You can use either the `external_id` that you specified when the remote file was [added](/methods/files.remote.add), _or_, for the `file` parameter, you can pass the `id` you received in the file response to the `add` method.
